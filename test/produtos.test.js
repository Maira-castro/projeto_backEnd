...
describe('Testando a rota de Produtos', () => {
       ...
       status: "200",
        ...
        detalhes: {
            ...
            options: [
                ...
                { id: 2, title: "Cor", shape: "circle", radius: 0, type: "color", values: "#F40404, #439580, #4fff" },
                ...
                { id: 27, title: "Tamanho", shape: "circle", radius: null, type: "color", values: "[\"#111\",\"#ddd\"]" },
                ...
                { id: 39, title: "Tamanho", shape: "circle", radius: null, type: "color", values: "[\"#111\",\"#ddd\"]" }
            ]
        }
    })
  });
  ...
  opcoesProduto.bulkCreate.mockResolvedValue([
      ...
      { id: 2, produtos_id: 1, title: "Tamanho", shape: "circle", radius: null, type: "color", values: '["#111", "#ddd"]' }
  ]);
